...
var _ServiceFrame = __webpack_require__(3);

var _ServiceFrame2 = _interopRequireDefault(_ServiceFrame);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var navbar = new _Navbar2.default(jQuery);
var serviceFrame = new _ServiceFrame2.default(jQuery);
...
var ServiceFrame = function () {
  function ServiceFrame() {
    _classCallCheck(this, ServiceFrame);

    this.frame = (0, _jquery2.default)("#service-frame");
  ...
  _createClass(ServiceFrame, [{
    ...
    value: function events() {
      ...
      this.btnRadStd.on("click", function () {
        return _this.onServiceClick(_this.btnRadStdUrl);
      });
      this.btnRadExp.on("click", function () {
        return _this.onServiceClick(_this.btnRadExpUrl);
      });
      this.btnOrthStd.on("click", function () {
        return _this.onServiceClick(_this.btnOrthStdUrl);
      });
      this.btnOrthExp.on("click", function () {
        return _this.onServiceClick(_this.btnOrthExpUrl);
      });
    }
  }, {
    key: "onServiceClick",
